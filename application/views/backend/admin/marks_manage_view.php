	    	...
	    	<div class="row">
				<div class="col-md-4">
					...
					<label class="control-label" style="margin-bottom: 5px;"><?php echo get_phrase('exam');?></label>
						<select name="exam_id" class="exam_id form-control selectboxit" required>
							<?php
			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						...
						<select name="section_id" id="section_selector_holder" class="section_id form-control" onchange="get_class_subject(this.value)">
								<?php 
				...
				<table class="table table-bordered">
					...
					?>
						<tr>
							...
							<td>
								<input type="number" step="any"  min="0" max="20" class="note form-control" name="marks_obtained_<?php echo $row['mark_id'];?>"
									value="<?php if (count($row['mark_obtained'])) echo sprintf("%.2f",$row['mark_obtained']);?>">	
							</td>
							<td>
								<input type="number" step="any" min="0" max="20" class="note form-control" name="test2_<?php echo $row['mark_id'];?>"
