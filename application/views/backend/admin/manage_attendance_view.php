                        ...
                        <tbody>
                            ...
                            foreach ($attendance_of_students as $row):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $this->db->get_where('student', array('student_id' => $row['student_id']))->row()->name .' '.$this->db->get_where('student', array('student_id' => $row['student_id']))->row()->surname; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" name="number_<?php echo $row['attendance_id']; ?>" value ="<?php $num = $this->db->get_where('attendance_total', array('attendance_id' => $row['attendance_id']))->result_array(); $k=count($num)-1; echo $num[$k]['number'] ?>" >
