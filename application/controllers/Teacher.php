...
class Teacher extends CI_Controller
{
  ...
  function student_profile($student_id)
  {
    ...
    function marks_selector()
    {
        ...
        $data['year']       = $this->db->get_where('settings' , array('type'=>'running_year'))->row()->description;
        if($data['class_id'] != '' && $data['exam_id'] != '' && $data['section_id'] != ' '&& $data['subject_id'] != ''){
    ...
    function marks_get_section_subject($class_id,$section_id)
    {
        ...
        $this->load->view('backend/teacher/marks_get_section_subject' , $page_data);
    }
