...
<div id="print">
    ...
    <table style="width:100%;">
        ...
        <td width="40%" style="padding-left:150px;">
            <p style="margin: 0;">Ministry of Basic Education</p>
