        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                    <?php echo form_open(site_url('admin/teacher/do_update/'.$row['teacher_id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" class="form-control" name="surname"
                                                                    value="<?php echo $row['surname'] == null ? '' : $row['surname'];?>" >
                                                            </div>
                                                        </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('higher_diploma');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="higher_diploma" value="<?php echo $row['higher_diploma'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('speciality');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="speciality" value="<?php echo $row['speciality'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('statut');?></label>
                                <div class="col-sm-5">
                                    <select name="statut" class="form-control selectboxit">
                                        <option value="permanent" <?php if($row['statut'] == 'permanent')echo 'selected';?>><?php echo get_phrase('permanent');?></option>
                                        <option value="temporary" <?php if($row['statut'] == 'temporary')echo 'selected';?>><?php echo get_phrase('temporary');?></option>
                                    </select>
                           </div>
                            </div>
