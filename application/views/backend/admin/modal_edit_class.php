...
$edit_data		=	$this->db->get_where('class' , array('class_id' => $param2) )->result_array();
 //$cycles  = array('0' => array('cycle_id' => '1' , 'name'=>'first cycle' ) ,'1' =>array('cycle_id' => '2' , 'name'=>'second cycle' ),'2' =>array('cycle_id' => '3' , 'name'=>'second cycle science' )         );
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="cycle" class="form-control" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                                <option value=""><?php echo get_phrase('select');?></option>
                                <?php 
                               
                                foreach($cycles as $row2):
                                ?>
                                    <option value="<?php echo $row2['cycle'];?>"
                                        <?php if($row['cycle'] == $row2['cycle'])echo 'selected';?>>
                                            <?php echo $row2['name'];?>
                                                </option>
                                <?php
                                endforeach;
