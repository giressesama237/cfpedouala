<div class="row">
	<div class="col-md-12">
      ...
      <?php echo form_open(site_url('admin/teacher/create/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('surname');?></label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('higher_diploma');?></label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="higher_diploma" value="" >
						</div>
					</div>
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('speciality');?></label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="speciality" value="" >
						</div>
					</div>
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('statut');?></label>

						<div class="col-sm-5">
							<select name="statut" class="form-control selectboxit">
                              <option value=""><?php echo get_phrase('select');?></option>
                              <option value="permanent"><?php echo get_phrase('permanent');?></option>
                              <option value="temporary"><?php echo get_phrase('semi-permanent');?></option>
                              <option value="temporary"><?php echo get_phrase('part-time');?></option>
                          </select>
						</div>
					</div>
					<div class="form-group">
					...
					<!--<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="email" value="" data-validate=""data-message-required="<?php echo get_phrase('value_required');?>"autofocus>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="password" class="form-control" name="password" value="" data-validate="">
						</div>
					</div>-->
						...
						<div class="col-sm-5">
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
									<img src="<?php  echo base_url('uploads/200x200.png');?>" alt="...">
								</div>
